...
tmsh delete /sys management-ip 10.11.0.11/24; 
tmsh create /sys management-ip 10.11.0.11/24; 
tmsh create /sys management-route default network default gateway 10.11.0.1;
...
tmsh create net self external-self address 10.11.1.11/24 vlan external;
tmsh create net vlan internal interfaces add { 1.2 } mtu 1500;
tmsh create net self internal-self address 10.11.2.11/24 vlan internal;
tmsh create /net route /LOCAL_ONLY/default network default gw 10.11.1.1; 
tmsh create /sys management-route /LOCAL_ONLY/aws_API_route network 169.254.169.254 gateway 10.11.0.1;
#submit cli transaction
#EOF
