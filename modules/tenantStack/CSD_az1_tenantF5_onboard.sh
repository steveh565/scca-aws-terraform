...
tmsh delete /sys management-ip 10.21.0.11/24; 
tmsh create /sys management-ip 10.21.0.11/24; 
tmsh create /sys management-route default network default gateway 10.21.0.1;
tmsh create /sys management-route /LOCAL_ONLY/aws_API_route network 169.254.169.254 gateway 10.21.0.1;
tmsh modify /sys dns name-servers replace-all-with { 10.21.0.2 } search replace-all-with { f5.com }
...
tmsh create net self external-self address 10.21.1.11/24 vlan external;
tmsh create net vlan internal interfaces add { 1.2 } mtu 1500;
tmsh create net self internal-self address 10.21.2.11/24 vlan internal;
tmsh create /net route /LOCAL_ONLY/default network default gw 10.21.1.1; 
...
# Telemetry Streaming
TS_URL='https://github.com/F5Networks/f5-telemetry-streaming/releases/download/v1.9.0/f5-telemetry-1.9.0-1.noarch.rpm'
TS_FN=$(basename "$TS_URL")
# Declarative Onboarding
DO_URL='https://github.com/F5Networks/f5-declarative-onboarding/releases/download/v1.10.0/f5-declarative-onboarding-1.10.0-2.noarch.rpm'
DO_FN=$(basename "$DO_URL")
# Application Services
AS3_URL='https://github.com/F5Networks/f5-appsvcs-extension/releases/download/v3.17.1/f5-appsvcs-3.17.1-1.noarch.rpm'
AS3_FN=$(basename "$AS3_URL")
# Cloud Failover
CF_URL='https://github.com/f5devcentral/f5-cloud-failover-extension/releases/download/v1.1.0/f5-cloud-failover-1.1.0-0.noarch.rpm'
